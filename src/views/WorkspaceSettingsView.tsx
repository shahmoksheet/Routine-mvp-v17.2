              ...
              <div className="p-6 text-center">
                ...
                <p className="text-sm text-slate-500 font-medium">
                  {activeWorkspace?.is_deactivated 
                    ? 'This will reactivate the workspace. All processes, recurring tasks, and workflows will resume their normal state without any gibberish data.' 
                    : 'This will deactivate the workspace. All running processes like recurring tasks, workflows, and notifications will be paused immediately so when reactivated there is no gibberish data.'}
                </p>
              </div>
