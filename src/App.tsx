...
import RecurringTemplatesView from './views/RecurringTemplatesView';
...
function AppContent() {
  ...
  useEffect(() => {
    if (user && localStorage.getItem('firstTimeOnboarding')) {
      localStorage.removeItem('firstTimeOnboarding');
        ...
        >
          <Routes>
            <Route element={<AuthenticatedLayout />}>
              ...
              <Route path="/recurring-templates" element={<RecurringTemplatesView />} />
